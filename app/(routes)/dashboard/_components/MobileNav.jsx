...
import { Menu, X, LayoutGrid, PiggyBank, ReceiptText, ShieldCheck, Bell, Bot } from 'lucide-react';
                            ...
                            <nav className="space-y-2">
                                {menuList.map((menu) => (
                                    <Link key={menu.key} href={menu.path} onClick={closeMenu}>
                                        <div className={`flex gap-3 items-center text-gray-500 font-medium p-3 cursor-pointer rounded-md 
